...
def generate_pdf_report(patient_name, image_path, prediction, confidence_scores, analysis_date, heatmap_path=None, info_dict=None, analysis_type='brain'):
...
def send_email_report(recipient_email, patient_name, pdf_buffer, filename):
    import smtplib
    ...
    try:
        msg = MIMEMultipart()
        msg['Subject'] = f'NeuroDetect AI Analysis Report - {patient_name}'
        ...
        Please find attached the AI analysis report for patient {patient_name}.
        
        Generated by NeuroDetect AI.
        """
