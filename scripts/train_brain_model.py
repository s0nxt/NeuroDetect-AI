...
DATASET_DIR = os.path.join(BASE_DIR, 'brain_dataset')
...
def main():
    ...
    checkpoint = ModelCheckpoint(
        os.path.join(BASE_DIR, 'models', 'brain_tumor_classifier_v2.keras'),
    ...
    print(f"Best model saved to {os.path.join(BASE_DIR, 'models', 'brain_tumor_classifier_v2.keras')}")
