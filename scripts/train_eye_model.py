...
DATASET_DIR = os.path.join(BASE_DIR, 'eye_dataset')
...
def main():
    ...
    checkpoint = ModelCheckpoint(
        os.path.join(BASE_DIR, 'models', 'diabetic_retinopathy_model.keras'),
    ...
    # 6. Save Model
    save_path = os.path.join(BASE_DIR, 'models', 'diabetic_retinopathy_model.keras')
